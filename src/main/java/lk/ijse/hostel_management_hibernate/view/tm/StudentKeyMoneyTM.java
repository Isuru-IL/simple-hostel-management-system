...
public class StudentKeyMoneyTM {
    ...
    public StudentKeyMoneyTM(String id, String address, LocalDate dob, String gender, String name,
                             String studentContact, String res_id, LocalDate date, String room_type, String key_money) {
        this.id = id;
